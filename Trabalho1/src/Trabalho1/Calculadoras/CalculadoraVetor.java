...
import Trabalho.Pilhas.PilhaVetor;

public class CalculadoraVetor {

	private String[] vetor;
	private PilhaVetor<Double> lista;
	private String msgErro = "";
	private boolean comErro = false;

	public CalculadoraVetor(String expressao) {
		
		this.vetor = expressao.split("\\s");
		this.lista = new PilhaVetor<>(this.vetor.length);
	}
